...
const apis = {
    ...
    getGoodListFS: requestUrl + '/cms/goods/findPage',
    addGoods: requestUrl + '/cms/goods/create',
    ...
    getHomeRotationFS: requestUrl+'/cms/carousel/findPage',
    addHomeRotation: requestUrl+'/cms/carousel/create',
    deleteHomeRotation: requestUrl+'/cms/carousel/delete',
    updateHomeRotation: requestUrl+'/cms/carousel/update',
    getCouponFS: requestUrl+'/cms/coupons/findPage',
    addCoupon: requestUrl + '/cms/coupons/create',
    deleteCoupon: requestUrl + '/cms/coupons/delete',
    updateCoupon: requestUrl+'/cms/coupons/update',
    findCouponById: requestUrl+'/cms/coupons/findById',
