<template>
    <div class="channels_box">
        ...
        <el-table :data="tableData" stripe style="width: 100%;padding: 20px">
            ...
            <el-table-column prop="useRules" label="使用规则"></el-table-column>
            <el-table-column prop="useScope" label="赠送数量"></el-table-column>
            <el-table-column label="优惠券弹窗海报">
            ...
            <el-table-column label="优惠券列表图片">
                <template slot-scope="scope">
                    <div>
                        <img width="80px" height="60px" :src="scope.row.couponsListPoster">
                    </div>
                </template>
            </el-table-column>
        ...
        <el-dialog :title="type=='add'?'新增优惠券':'修改优惠券'" :visible.sync="dialogFormVisible">
            <el-form :model="form">
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="优惠券类型：" :label-width="formLabelWidth">
                            <el-select v-model="form.couponsType" placeholder="请选择优惠券类型">
                                ...
                                <el-option label="团购券" value="3"></el-option>
                    ...
                    <el-col :span="12">
                        <el-form-item label="使用范围：" :label-width="formLabelWidth">
                            <el-select v-model="form.useScope" placeholder="请选择优惠券类型">
                ...
                <el-form-item label="优惠券弹窗海报" :label-width="formLabelWidth">
                    <el-upload
                            class="upload-demo"
                            action="http://47.106.172.126:9001/tea/cms/image/upload"
                            :on-success="handleCouponsPosterSuccess"
                            :on-remove="handleRemove"
                            :file-list="fileCouponsPosterList"
                            list-type="picture">
                        <el-button size="small" type="primary">点击上传</el-button>
                    </el-upload>
                </el-form-item>
                <el-form-item label="优惠券列表图片" :label-width="formLabelWidth">
                    <el-upload
                            class="upload-demo"
                            action="http://47.106.172.126:9001/tea/cms/image/upload"
                            :on-success="handleCouponsListPosterSuccess"
                            :on-remove="handleRemove"
                            :file-list="fileCouponsListPosterList"
                            list-type="picture">
                        <el-button size="small" type="primary">点击上传</el-button>
                    </el-upload>
                </el-form-item>
    ...
    export default {
        ...
        data() {
            return {
                ...
                fileCouponsListPosterList: [],
                fileCouponsPosterList: []
        ...
        methods: {
            toAdd() {
                ...
                this.fileCouponsListPosterList = []
                this.fileCouponsPosterList = []
            ...
            toSave() {
                if (this.type == "add") {
                    ...
                    let parm = {
                        ...
                        couponsListPoster: this.form.couponsListPoster
                    }
            ...
            getTableListFS() {
                ...
                let condition
                if (this.couponsName !== '') {
                    condition = {"couponsName": this.couponsName}
                }
            ...
            handleCouponsPosterSuccess(file) {
                this.form.couponsPoster = file
            },
            handleCouponsListPosterSuccess(file) {
                this.form.couponsListPoster = file
            },
            ...
            handleEdit(index, row) {
                ...
                this.form.couponsListPoster = row.couponsListPoster
                this.form.id = row.id
                this.fileCouponsPosterList = [{name: row.couponsPoster, url: row.couponsPoster}]
                this.fileCouponsListPosterList = [{name: row.couponsListPoster, url: row.couponsListPoster}]
            },
        }
    }
</script>
